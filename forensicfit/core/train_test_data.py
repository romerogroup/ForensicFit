...
class TrainTestData(Mapping):
    ...
    def __init__(self, data, labels, test_size=0.2, train_size=None, random_state=None, shuffle=True, stratify=None):
        self.values = {}
        self.metadata = {}
        self.data = data
        self.labels = labels
        ...
        X_train, X_test, y_train, y_test = train_test_split(
            data, labels, test_size, train_size, random_state, shuffle, stratify)
    ...
    def load_dict(self):
        ...
        self.values['labels'] = self.labels
    ...
    def redraw(self, test_size=0.2, train_size=None, random_state=None, shuffle=True, stratify=None):
        self.test_size = test_size
        self.train_size = train_size
        self.random_state = random_state
        self.shuffle = shuffle
        self.stratify = stratify
        X_train, X_test, y_train, y_test = train_test_split(
            self.data, self.labels, test_size, train_size, random_state, shuffle, stratify)
        self.train = Data(X_train, y_train)
        self.test = Data(X_test, y_test)
        self.load_dict()
        self.load_metadata()
